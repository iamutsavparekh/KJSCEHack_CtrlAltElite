...
exports.getReactionsValidator = exports.getReactionsHandler = void 0;
...
var handler = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var imageId, existingUser, reactions;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, like_1.Like.findOne({ imageId: imageId })];
            case 1:
                reactions = _a.sent();
                res.status(http_status_codes_1.StatusCodes.OK).send(reactions);
                return [2 /*return*/];
        }
    });
}); };
exports.getReactionsHandler = handler;
var validator = [
    (0, express_validator_1.param)('imageId')
        .notEmpty()
        .isMongoId()
];
exports.getReactionsValidator = validator;
