...
exports.getUserImagesHandler = void 0;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, image_1.Image.find({ userId: existingUser._id })];
            case 1:
                images = _a.sent();
                res.status(http_status_codes_1.StatusCodes.OK).send(images);
                return [2 /*return*/];
        }
    });
}); };
exports.getUserImagesHandler = handler;
