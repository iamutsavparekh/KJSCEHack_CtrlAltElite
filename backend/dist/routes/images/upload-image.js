    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!req.file) {
                    throw new bad_request_error_1.BadRequestError("Please provide a valid image");
                }
                if (!mongoose_1.default.isValidObjectId(req.params.imageId)) {
                    throw new bad_request_error_1.BadRequestError("Provide valid image id");
                }
                return [4 /*yield*/, image_1.Image.findById(req.params.imageId)];
            case 1:
                image = _a.sent();
                if (!image) {
...
exports.uploadImageHandler = handler;
